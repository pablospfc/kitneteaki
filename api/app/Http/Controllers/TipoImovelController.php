...
class TipoImovelController extends Controller
{
    ...
    {
        try {
            $dados = \App\Model\TipoImovel::all();
    ...
    {
        try {
            \App\Model\TipoImovel::create($request->all());
    ...
    {
        try {
            $data = \App\Model\TipoImovel::find($id);
    ...
    {
        try {
            \App\Model\TipoImovel::where('id', $id)
                ->update($request->all());
    ...
    {
        try {
            \App\Model\TipoImovel::destroy($id);
