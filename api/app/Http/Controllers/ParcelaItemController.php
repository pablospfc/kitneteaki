...
class ParcelaItemController extends Controller
{
    ...
    public function getByParcela($idParcela) {
        try {
            $dados = \App\Model\ParcelaItem::where('id_parcela', $idParcela)
                ->get();
    ...
    public function destroy($id)
    {
        try {
            ...
            \App\Model\Log::create(['message' => $e->getMessage()]);
            return response()->json(['message' => 'Ocorreu um problema ao excluir registro.'], 500);
        }
    }
}
